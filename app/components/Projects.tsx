const projects = [
  {
    ...
    description:
      "Dynamisk blogg med kommentarer, likes och responsiv design byggd med vanilla JS.",
  ...
  },
  {
    title: "Road2",
    description:
      "App som hjälper dig sätta mål, bryta ner dem i steg och följa din progress.",
    tech: ["Pågår"],
